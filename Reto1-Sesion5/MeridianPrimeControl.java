...
public class SistemaGestionMeridiano {
    // Código personalizado para evitar duplicidad
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Flux<String> semaforos = Flux.interval(Duration.ofMillis(400))
                ...
                .transform(SistemaGestionMeridiano::controlarSemaforos); // Control de 3 rojos seguidos
